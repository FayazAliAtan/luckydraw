...
<style>
  ...
  .navbar.scrolled {
    background: linear-gradient(90deg, #6a11cb, #2575fc); /* Darker gradient on scroll */
  ...
  .navbar-toggler-icon {
    background-image: url("data:image/svg+xml;charset=UTF8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='%23ff7e5f' viewBox='0 0 16 16'%3E%3Cpath fill-rule='evenodd' d='M1.5 12.5a.75.75 0 0 0 0 1.5h13a.75.75 0 0 0 0-1.5h-13zm0-5.5a.75.75 0 0 0 0 1.5h13a.75.75 0 0 0 0-1.5h-13zm0-5.5a.75.75 0 0 0 0 1.5h13a.75.75 0 0 0 0-1.5h-13z'/%3E%3C/svg%3E");
  }
  /* Cards */
  .card {
    border-radius: 18px;
